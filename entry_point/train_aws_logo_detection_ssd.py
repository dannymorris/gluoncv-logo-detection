...
class GroundTruthDetectionDataset(gluon.data.Dataset):
    ...
    """
    def __init__(self, label_path='label', data_path='data', split='train', task='aws-logo-detection'):
        """
        Parameters
        ---------
...
def train(): 
    ...
    model = gcv.model_zoo.get_model('ssd_512_mobilenet1.0_custom', classes=["AWS"], pretrained_base=False, transfer='voc')
